  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.text}>
        <span className={styles.text__tag}>Healthy</span>
        <span className={styles.text__title}>Chiken Hell</span>
      </div>
      <div className={styles.info}>
        <span className={styles.info__time}>24min</span>
        <span className={styles.info__dot}>•</span>
        <div className={styles.info__rate}>
          <img src={star} alt="" />
          <span className={styles.info__}>4.8</span>
        </div>
      </div>
      <div className={styles.order}>
        <div className={styles.price}>
          <span className={styles.price__currency}>$</span>
          <span className={styles.price__value}>12</span>
          <span className={styles.price__value_sub}>.99</span>
        </div>
        <button>+</button>
      </div>
